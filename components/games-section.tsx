...
const games = [
  ...
  },
  {
    ...
    character: "/cs2-agent-premium-3d.png",
    players: 5,
    rank: "#2 Regional",
    description: "Tactical FPS",
  },
  {
    name: "Rocket League",
    slug: "rocket-league",
    logo: "/rocket-league-inspired-logo.png",
    character: "/rocket-league-octane-premium-3d.png",
    players: 3,
    rank: "#4 National",
    description: "Sports",
  },
  {
    ...
    character: "/mobile-legends-hero-premium-3d.png",
    players: 5,
    rank: "#1 Regional",
  ...
  },
  {
    name: "FIFA/FC",
    slug: "fifa-fc",
    logo: "/fifa-fc-logo.png",
    character: "/fifa-player-premium-3d.png",
    players: 1,
    rank: "#2 National",
